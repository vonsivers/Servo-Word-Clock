#ifndef RO_PAGE_NETWORKCONFIGURATION_RO_H
#define RO_PAGE_NETWORKCONFIGURATION_RO_H
...
<a href="/"  class="btn btn--s"><</a>&nbsp;&nbsp;<strong>Configurare Re&#539;ea</strong>
<hr>
Conectare la router cu aceste set&#259;ri:<br>
<form action="" method="get">
<table border="0"  cellspacing="0" cellpadding="3" style="width:310px" >
<tr><td align="right">SSID:</td><td><input type="text" id="ssid" name="ssid" value=""></td></tr>
<tr><td align="right">Parol&#259;:</td><td><input type="text" id="password" name="password" value=""></td></tr>
...
<hr>
<strong>Stare Conectare:</strong><div id="connectionstate">N/A</div>
<hr>
<strong>Re&#539;ele:</strong><br>
<table border="0"  cellspacing="3" style="width:310px" >
<tr><td><div id="networks">Se scaneaz&#259;...</div></td></tr>
<tr><td align="center"><a href="javascript:GetState()" style="width:150px" class="btn btn--m btn--blue">Scanare</a></td></tr>
</table>
...
V&#259; rug&#259;m s&#259; a&#349;tepta&#539;i pu&#539;in.... Se configureaz&#259; &#349;i se restarteaz&#259; ceasul.
)=====";
...
void send_connection_state_values_html()
{
	...
	String state = "N/A";
	String Networks = "";
	if (WiFi.status() == 0) state = "&#206;n a&#351;teptare";//"Idle";
	else if (WiFi.status() == 1) state = "Nu s-a g&#259sit SSID"; //"NO SSID AVAILBLE";
	else if (WiFi.status() == 2) state = "Scanare terminat&#539;"; //"SCAN COMPLETED";
	else if (WiFi.status() == 3) state = "Conectat"; //"CONNECTED";
	else if (WiFi.status() == 4) state = "Conectare nereu&#351;it&#539;";//"CONNECT FAILED";
	else if (WiFi.status() == 5) state = "Conectare pierdut&#539;"; //"CONNECTION LOST";
	else if (WiFi.status() == 6) state = "Deconectat"; //"DISCONNECTED";
	...
	else
    {
		...
		Networks = "S-au g&#259;sit " +String(n) + " re&#539;ele<br>";
		Networks += "<table border='0' cellspacing='0' cellpadding='3'>";
		Networks += "<tr bgcolor='#DDDDDD' ><td><strong>Nume</strong></td><td><strong>Semnal</strong></td><td><strong></strong></td><tr>";
		for (int i = 0; i < n; ++i)
		{
			int quality=0;
			if(WiFi.RSSI(i) <= -100)
...
#endif /* RO_PAGE_NETWORKCONFIGURATION_RO_H */
