#ifndef RO_PAGE_DISPLAYSETTINGS_RO_H
#define RO_PAGE_DISPLAYSETTINGS_RO_H

const char PAGE_DisplaySettings[] PROGMEM = R"=====(
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<a href="/"  class="btn btn--s"><</a>&nbsp;&nbsp;<strong>Set&#259;ri afi&#351;are</strong>
<hr>
<form action="" method="get">
<table border="0"  cellspacing="0" cellpadding="3" >
<tr><td align="right">Culoare de baz&#259;</td><td><input id="start-color" name="start-color" type="color" value="#000000" style="width:150px"></td></tr>
<tr><td align="right"> </td><td> </td></tr>
<tr><td align="right">Culoare secundar&#259;</td><td><input id="end-color" name="end-color" type="color" value="#000000" style="width:150px"></td></tr>
<tr><td align="right"> </td><td></td></tr>
<tr><td align="right">'ESTE ORA':</td><td><input type="checkbox" id="c_e_o" name="c_e_o"></td></tr>
...
#endif /* RO_PAGE_DISPLAYSETTINGS_RO_H */
