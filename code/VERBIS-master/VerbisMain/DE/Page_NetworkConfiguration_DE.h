#ifndef PAGE_NETWORKCONFIGURATION_DE_H
#define PAGE_NETWORKCONFIGURATION_DE_H
...
<a href="/"  class="btn btn--s"><</a>&nbsp;&nbsp;<strong>Netzwerkkonfiguration</strong>
<hr>
Verbinden Sie sich mit diesen Einstellungen mit dem Router:<br>
<form action="" method="get">
<table border="0"  cellspacing="0" cellpadding="3" style="width:310px" >
<tr><td align="right">SSID:</td><td><input type="text" id="ssid" name="ssid" value=""></td></tr>
<tr><td align="right">Passwort:</td><td><input type="text" id="password" name="password" value=""></td></tr>
...
<tr><td colspan="2" align="center"><input type="submit" style="width:150px" class="btn btn--m btn--blue" value="Speichern"></td></tr>
</table>
</form>
<hr>
<strong>Verbindungsstatus:</strong><div id="connectionstate">N/A</div>
<hr>
<strong>Netzwerke:</strong><br>
<table border="0"  cellspacing="3" style="width:310px" >
<tr><td><div id="networks">Scannen ...</div></td></tr>
<tr><td align="center"><a href="javascript:GetState()" style="width:150px" class="btn btn--m btn--blue">Aktualisierung</a></td></tr>
</table>
...
Bitte warten .... Konfigurieren und Neustarten.
)=====";
...
void send_connection_state_values_html()
{
	...
	String state = "N/A";
	String Networks = "";
	if (WiFi.status() == 0) state = "Leerlauf";
	else if (WiFi.status() == 1) state = "KEINE SSID VERFÜGBAR";
	else if (WiFi.status() == 2) state = "SCAN ABGESCHLOSSEN";
	else if (WiFi.status() == 3) state = "VERBUNDEN";
	else if (WiFi.status() == 4) state = "VERBINDUNG FEHLGESCHLAGEN";
	else if (WiFi.status() == 5) state = "VERBINDUNG UNTERBROCHEN";
	else if (WiFi.status() == 6) state = "GETRENNT";
	 ...
	 if (n == 0)
	 {
		 Networks = "<font color='#FF0000'>Keine Netzwerke gefunden!</font>";
	 }
	else
    {


		Networks = String(n) + " Netzwerke gefunden<br>";
		Networks += "<table border='0' cellspacing='0' cellpadding='3'>";
		Networks += "<tr bgcolor='#DDDDDD' ><td><strong>Name</strong></td><td><strong>Qualit&auml;t</strong></td><td><strong>Besch.</strong></td><tr>";
		for (int i = 0; i < n; ++i)
		{
			int quality=0;
			if(WiFi.RSSI(i) <= -100)
